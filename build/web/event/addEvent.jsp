<%-- 
    Document   : addEvent
    Created on : 5 Apr 2024, 3:44:34 pm
    Author     : USER
--%>
                        ...
                        <div class="card-body">
                          ...
                          <form class="forms-sample">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Year">
                            </div>
                            <div class="form-group">
                              <label for="exampleInputConfirmPassword1">Category</label>
                              <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="category">
                            </div>
                            
                            <div class="form-group">
                                <label for="exampleInputConfirmPassword1">Program</label>
                                <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="program">
                              </div>
